...
class acf_field_gallery extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'acf-input-gallery', acf_get_external_dir(__FILE__, 'js/input.js'), array('acf-input'), '2.0.0' );
		wp_enqueue_style( 'acf-input-gallery', acf_get_external_dir(__FILE__, 'css/input.css'), array('acf-input'), '2.0.0' );
